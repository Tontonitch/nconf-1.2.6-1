...
$mandatory_constants_empty = array('OS_LOGO_PATH','CONF_DEPLOY_URL','CONF_DEPLOY_USER','CONF_DEPLOY_PWD','AUTH_FEEDBACK_AS_WELCOME_NAME','GROUP_USER','GROUP_NOBODY','LDAP_SERVER','LDAP_PORT','BASE_DN','USER_REPLACEMENT','GROUP_DN','ADMIN_GROUP','USER_GROUP','AUTH_DBHOST','AUTH_DBNAME','AUTH_DBUSER','AUTH_DBPASS','AUTH_SQLQUERY_USER','AUTH_SQLQUERY_ADMIN');
